const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ModuleMap-Cgd-I_v7.js","assets/curriculum-DNetKi3g.js","assets/vendor-DUI7kKlB.js","assets/ModuleMap-FzVFw7e_.css","assets/LessonList-BUgCx9pj.js","assets/LessonList-COilrcCA.css","assets/LessonView-CvOPPXYS.js","assets/LessonView-Dq4w3eqP.css"])))=>i.map(i=>d[i]);
import { r as requireReact, a as requireReactDom } from "./vendor-DUI7kKlB.js";
(function polyfill() {
...
function ThemeProvider({ children }) {
  ...
  const value = reactExports.useMemo(() => ({ theme, toggleTheme }), [theme, toggleTheme]);
...
function awardXp(progress, lesson, isPerfect = false) {
...
function updateStreak(streak, todayStr) {
  ...
  const lastDate = /* @__PURE__ */ new Date(streak.lastDate + "T00:00:00");
  const today = /* @__PURE__ */ new Date(todayStr + "T00:00:00");
  const diffDays = Math.round((today - lastDate) / (1e3 * 60 * 60 * 24));
  if (diffDays === 1) {
...
function getModuleProgress(moduleId, totalLessons, progress) {
...
const ProgressContext = reactExports.createContext();
function ProgressProvider({ children }) {
  const [progress, setProgress] = reactExports.useState(() => loadProgress());
  const updateProgress = reactExports.useCallback((updater) => {
    setProgress((prev) => {
  ...
  const completeLesson = reactExports.useCallback((moduleId, lessonId, lesson, isPerfect = false) => {
    updateProgress((prev) => {
  ...
  const completeModule = reactExports.useCallback((moduleId) => {
    updateProgress((prev) => ({
      ...prev,
      modules: {
        ...prev.modules,
  ...
  const saveQuizScore = reactExports.useCallback((lessonId, score, total) => {
    updateProgress((prev) => ({
      ...prev,
      quizScores: {
        ...prev.quizScores,
...
function useRouter() {
  const [state, setState] = reactExports.useState(() => parseHash(window.location.hash));
  reactExports.useEffect(() => {
...
class ErrorBoundary extends reactExports.Component {
  ...
  render() {
    if (this.state.hasError) {
      const errorMsg = this.state.error?.message ? String(this.state.error.message) : "Unknown error";
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "2rem", textAlign: "center", fontFamily: "system-ui" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Something went wrong" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#666", margin: "1rem 0" }, children: errorMsg }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#999", fontSize: "0.8rem" }, children: "Check browser console (F12) for details" }),
...
const topBar = "_topBar_lzivt_1";
const logo = "_logo_lzivt_14";
const logoMark = "_logoMark_lzivt_21";
const logoText = "_logoText_lzivt_34";
const stats = "_stats_lzivt_40";
const stat = "_stat_lzivt_40";
const streakIcon = "_streakIcon_lzivt_55";
const xpBadge = "_xpBadge_lzivt_60";
const themeToggle = "_themeToggle_lzivt_69";
const styles$1 = {
  topBar,
  logo,
  logoMark,
...
function TopBar({ onLogoClick }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: styles$1.topBar, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.logoMark, children: "C" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$1.logoText, children: "Claude Codex" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.stats, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          className: styles$1.themeToggle,
          onClick: toggleTheme,
          "aria-label": "Toggle theme",
          children: theme === "light" ? "☾" : "☀"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.stat, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$1.streakIcon, children: "🔥" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: progress.streak.current })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.xpBadge, children: [
        progress.xp,
        " XP"
      ] })
    ] })
...
const app = "_app_l8yp0_1";
const content = "_content_l8yp0_7";
const styles = {
  app,
  content
};
const ModuleMap = reactExports.lazy(() => __vitePreload(() => import("./ModuleMap-Cgd-I_v7.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0));
const LessonList = reactExports.lazy(() => __vitePreload(() => import("./LessonList-BUgCx9pj.js"), true ? __vite__mapDeps([4,1,2,5]) : void 0));
const LessonView = reactExports.lazy(() => __vitePreload(() => import("./LessonView-CvOPPXYS.js"), true ? __vite__mapDeps([6,1,2,7]) : void 0));
function AppContent() {
  const { route, params, navigate, goHome } = useRouter();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.app, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TopBar, { onLogoClick: goHome }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: styles.content, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Suspense, { fallback: null, children: [
      route === "home" && /* @__PURE__ */ jsxRuntimeExports.jsx(ModuleMap, { onModuleClick: (id) => navigate(`/module/${id}`) }),
      route === "module" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        LessonList,
        {
          moduleId: params.moduleId,
          onBack: goHome,
          onLessonClick: (lessonId) => navigate(`/module/${params.moduleId}/lesson/${lessonId}`)
        }
      ),
      route === "lesson" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        LessonView,
        {
          moduleId: params.moduleId,
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppContent, {}) }) }) });
}
clientExports.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) })
);
export {
  getModuleProgress as g,
  jsxRuntimeExports as j,
  reactExports as r,
  useProgressContext as u
};
//# sourceMappingURL=index-rEfxmL-f.js.map
